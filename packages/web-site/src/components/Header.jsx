...
function Header() {
    ...
    return (
        <header className='z-50 md:mx-auto max-w-7xl md:w-9/10 bg-white/10 backdrop-blur-xl ring ring-white/20 rounded-3xl flex justify-between items-center fixed mt-4 p-4 md:p-6 top-0 gap-8'>
